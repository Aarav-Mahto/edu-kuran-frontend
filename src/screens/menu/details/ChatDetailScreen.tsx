...
const ChatDetailScreen = () => {
  ...
  const { chatType } = route.params as { chatType: string };
      ...
      <ScrollView className="flex-1 px-4 pt-4">
        <View className="bg-white rounded-lg p-6 shadow-sm">
          ...
          <Text className="text-gray-600 mb-4">
            This is a placeholder screen for {chatType} chat functionality. 
            You can implement the actual chat interface here.
          </Text>
