...
export default function TutsCaredBackground({
    width = 120,
    height = 170,
    imageSource,
    imageStyle,
    ...
    const tl = 0, tr = 10, br = 30, bl = 0;

    return (
        <View className="w-[140px] h-[200px] overflow-hidden">
            <Svg width="100%" height="100%" viewBox={`0 0 ${width} ${height}`}>
                ...
                {/* Background */}
                {/* <Rect width={width} height={height} rx="20" fill="url(#bgGradient)" /> */}
                ...
                {/* Crescent + star */}
                <G transform={`translate(${width * 0.75}, ${height * 0.15})`}>
